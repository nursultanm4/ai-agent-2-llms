...
export default function App() {
  ...
  const sendQuestion = async (): Promise<void> => {
    ...
    //   проверяем не пустое ли сообщение отправил юзер ИЛИ на то отправил ли вообще ли он вообще сообщение - если хоть 1 из этих True, то нельзя отправить еще сообщение пока не станет False. 
